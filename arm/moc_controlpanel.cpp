...
void ControlPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ControlPanel::openDeviceClicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ControlPanel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ControlPanel::closeDeviceClicked)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (ControlPanel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ControlPanel::settingChanged)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject ControlPanel::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_ControlPanel.data,
